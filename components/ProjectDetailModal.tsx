...
import { Project, Task, ProjectLog, ProjectStatus, Priority, EisenhowerQuadrant, AISettings } from '../types.ts';
...
import { generateProjectPlan } from '../services/aiService.ts';
